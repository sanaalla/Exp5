//Experiment 4 - Messaging and Notifications
//"Get Me Coffee"
//DIGF-6037-001 Creation & Computation
//Digital Futures MDes, Nov. 25 2017
//Sana Shepko and Sean Harkin

//Code based on examples by Kate Hartman and Nick Puckett. People who also helped us in the process by looking over our code: Max Lander, Feng Yuan, Roxanne Henry

//A messaging system intended to notify members of a group, class, or office space when someone is going to get coffee, in case others want coffee too. 
//This system would be materialized in the form of a small device in the shape of a symbolic coffee cup (perhaps a keychain) with a toggle and two LEDs.
...
const static char pubChannel[] = "sean"; //choose a name for the channel to publish messages to
const static char subChannel[] = "sana"; //choose a name for the channel to publish messages to
